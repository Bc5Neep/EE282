...
```EnhancedVolcano(
  ...
  selectLab = top10_genes_3,        # Top 5 up + Top 5 down
...
```any(duplicated(names(geneList)))   # should be FALSE
```
...
```any(duplicated(names(geneList1)))   # should be FALSE
```
